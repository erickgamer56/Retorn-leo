        ...
        <div class="right">
            <div class="gap">
                <label for="file" class="lol">
                        <span class="foto">
                            <i class='bx bxs-file-doc' id="icam"></i>
                            <img src="" id="uimg">
                        </span>
                        <h2>Comprove sua entrega com uma foto !</h2>
                </label>
                <div class="p2">
                    <select id="tipo" name="tipo" class="ori_inp">
                        <option value="sabao">Menos de 1 Litro = 100 RECOPOINT</option>
                        <option value="produto">Menos de 5 Litros = 500 RECOPOINT</option>
                        <option value="produto">Menos de 10 litros = 10,000 RECOPOINT</option>
                    </select>
                </div>
            </div>
        </div>
